...
function my_first_theme_setup() {
	...
	register_nav_menus(
		array(
			'menu-1' => esc_html__( 'Left Menu', 'my-first-theme' ),
			'menu-2' => esc_html__( 'Right Menu', 'my-first-theme' ),
		)
	);
	...
	add_theme_support(
		'custom-background',
		apply_filters(
			'my_first_theme_custom_background_args',
			array(
...
function my_first_theme_scripts() {
	wp_enqueue_style( 'my-first-theme-style', get_stylesheet_uri(), array(), _S_VERSION );
	wp_style_add_data( 'my-first-theme-style', 'rtl', 'replace' );

	wp_enqueue_script( 'my-first-theme-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
